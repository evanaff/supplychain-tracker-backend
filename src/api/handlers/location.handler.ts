...
import { ListLocationsQueryDTO } from "../../common/dto";
...
export const putEditLocationByGlnHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
        // Get Params
        const gln = req.params.gln as string;
        ...
        // Edit Location
        await locationService.editLocationByGln(gln, payload);
